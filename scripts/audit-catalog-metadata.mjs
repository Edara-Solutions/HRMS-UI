...
/** One catalog entry, written the way Biome would format it so no formatting pass is needed. */
...
/**
 * The generated module's exact text. It is already Biome-formatted, so the drift gate can
 * compare what this renders against what is committed byte for byte.
 */
